...
if (user.profile_image) {
    ...
    document.getElementById("profileImage").src =
        "https://healthcare-patient-portal.onrender.com/uploads/" + user.profile_image;
...
document.getElementById("profileForm").addEventListener("submit", function(event){
    ...
    fetch("https://healthcare-patient-portal.onrender.com/profile", {
...
document.getElementById("uploadImageBtn").addEventListener("click", function () {
    ...
    fetch("https://healthcare-patient-portal.onrender.com/upload-profile", {
    ...
    .then(data => {
        ...
        if (data.success) {
            ...
            document.getElementById("profileImage").src =
                "https://healthcare-patient-portal.onrender.com/uploads/" + data.image;
